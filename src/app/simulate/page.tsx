...
const Simulate = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Safety check for user.credits (might be missing if auth not fully loaded, though !user check handles most)
    ...
    try {
      const _simulationId = await createSimulation({
        ...
        pdbFile: proteinFile.name, // Note: This just sends the name. Actual file upload logic to storage would be needed here.
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <Card className="border-border/40 bg-card/50 backdrop-blur-sm">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle
                      ...
                      onClick={() =>
                        setEnableEquilibration(!enableEquilibration)
                      }
                    >
                ...
                {enableEquilibration && (
                  <CardContent className="space-y-4">
                    <p className="text-muted-foreground text-sm">
                      Configure separate parameters for the equilibration phase
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="equilibrationTemp">
                          Temperature (K)
                        </Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="equilibrationPressure">
                          Pressure (bar)
                        </Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="equilibrationTimestep">
                          Time Step (fs)
                        </Label>
                        <Input
              ...
              <div className="flex items-center justify-end gap-4 p-4">
                <div className="text-right">
                  ...
                  <p className="text-muted-foreground text-xs">Estimated Cost ~${_estimatedCost}</p>
                </div>
                <Button
                  size="lg"
